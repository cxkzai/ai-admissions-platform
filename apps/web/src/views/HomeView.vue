        ...
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            <div class="mb-3 flex items-center gap-2">
              ...
              <span class="font-mono text-sm text-ink-500">{{ stack.layer }}</span>
            </div>
            <ul class="space-y-1.5">
              <li
                v-for="item in stack.items"
                :key="item"
                class="flex items-center gap-2 text-sm text-ink-100"
              >
      ...
      <div class="container-page">
        ...
        <div class="overflow-x-auto rounded-lg border border-ink-800">
          <table class="w-full min-w-[640px] font-mono text-sm">
            ...
            <tbody class="divide-y divide-ink-800 bg-ink-900 text-ink-300">
              <tr>
                <td class="px-4 py-3">自研代码</td>
                <td class="px-4 py-3 text-center text-spark">✓ 100%</td>
                <td class="px-4 py-3 text-center">—</td>
                <td class="px-4 py-3 text-center">—</td>
                <td class="px-4 py-3 text-center">—</td>
              </tr>
              <tr>
                <td class="px-4 py-3">多角色 Agent</td>
                <td class="px-4 py-3 text-center text-spark">✓ 4 类</td>
                <td class="px-4 py-3 text-center">需编排</td>
                <td class="px-4 py-3 text-center">需编排</td>
                <td class="px-4 py-3 text-center">✗</td>
              </tr>
              <tr>
                <td class="px-4 py-3">RAG 自定义切片</td>
              ...
              <tr>
                <td class="px-4 py-3">Function Calling</td>
                <td class="px-4 py-3 text-center text-spark">✓ 完全自定义</td>
                <td class="px-4 py-3 text-center">✓</td>
                <td class="px-4 py-3 text-center">✓</td>
                <td class="px-4 py-3 text-center">弱</td>
              </tr>
              <tr>
                <td class="px-4 py-3">工作流导出兼容</td>
                <td class="px-4 py-3 text-center text-spark">✓</td>
                <td class="px-4 py-3 text-center">—</td>
                <td class="px-4 py-3 text-center">—</td>
                <td class="px-4 py-3 text-center">—</td>
